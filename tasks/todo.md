...
- [x] Expand CI to `macos` + `ubuntu` + `windows` on the pinned toolchain and locked dependencies;
      ...
      - 2026-09-08 09:1x: exact head `977fb3c` (tip of `main`, #118) is green on Gate (macOS),
        Gate (Ubuntu) and Gate (Windows) in run `34225076344` (completed 12:40:45 UTC), the
        second completed three-platform success on `main` since `eeb717b`; `2ca73d9` (#114)
