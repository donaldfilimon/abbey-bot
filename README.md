...
Honesty note: **verified live on 2026-08-19 from Donald's Discord client: gateway
+ global registration (16 commands, 58 guilds), slash commands answering
(`/admin export`, `/recall`), DM replies generated by ollama `gemma4:12b` with a
per-DM transcript, guild-mention replies, reactions reaching the reward
collector. Not yet observed: a reward *settling* into a replay buffer,
Telegram, Slack, vision.** This host has neither Docker nor systemd, so both
